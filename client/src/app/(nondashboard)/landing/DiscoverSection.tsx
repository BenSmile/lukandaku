...
const DiscoverSection = () => {
    return (
        ...
        >
            <div className="max-w-6xl xl:max-w-7xl mx-auto px-6 sm:px-8 xl:px-16 text-center">
                <motion.div
                ...
                >
                    ...
                    <p className='mt-2 text-gray-500 max-w-3xl mx-auto'>
                        Searching for your dream rental property has never been easier. With our
                        user-friendly search feature, you can quickly find the perfect
